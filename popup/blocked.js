...
if (isConfirmed) {
    ...
    if (proceedBtn) {
        ...
        warning.innerHTML = "<b>Security Enforcement:</b> This site is confirmed as malicious by global threat intelligence. Manual bypass is disabled for your protection.";
